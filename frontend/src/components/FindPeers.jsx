      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-8">
          ...
          <p className="text-gray-500 mt-1">
            Connect with classmates who share your courses and study
            preferences.
          </p>
        ...
        <div>
          ...
          <div className="space-y-6">
            {peers.length > 0 ? (
              ...
              <p className="text-center text-gray-500 py-8 bg-white rounded-lg shadow-sm border">
                No peer suggestions available right now. Enroll in more courses
      ...
      <div className="flex-1">
        <div className="flex justify-between items-start mb-3">
          <p className="text-gray-600">
            {/* Placeholder description */}A passionate learner looking for
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="px-5 py-2 bg-gray-200 text-gray-800 font-semibold rounded-lg hover:bg-gray-300 transition">
            Message
          </button>
        </div>
      </div>
